...
export async function seedMenu(
  ...
  await seedMenuIngredients(prisma, menus)
...
async function seedMenuIngredients(
  ...
  if (!firstMenu?.program?.sppgId) {
    console.log('  ⚠️  No SPPG ID found in menu program')
    return
  }
  ...
  // Helper function to find inventory item by code
  ...
  await prisma.menuIngredient.createMany({
    data: [
      ...
      {
        menuId: menu1.id,
        inventoryItemId: findInventoryItem('NKM-001')?.id,
      ...
      {
        menuId: menu1.id,
        inventoryItemId: findInventoryItem('SNT-001')?.id,
      ...
      {
        menuId: menu1.id,
        inventoryItemId: findInventoryItem('GLM-001')?.id,
      ...
      {
        menuId: menu1.id,
        inventoryItemId: findInventoryItem('LKS-001')?.id,
      ...
      {
        menuId: menu1.id,
        inventoryItemId: findInventoryItem('DSL-001')?.id,
    ...
    data: [
      {
        ...
        costPerUnit: 12,
        totalCost: 960,
        preparationNotes: 'Cuci beras 80 gram hingga air jernih, rendam 15 menit. Masak dengan perbandingan air 1.2:1 untuk nasi pulen yang pas. Nasi harus hangat dan tidak terlalu lembek agar cocok dimakan dengan lalapan segar.',
      ...
      },
      {
        menuId: menu2.id,
        inventoryItemId: findInventoryItem('AYM-001')?.id,
        ingredientName: 'Ayam Broiler Paha',
        quantity: 100,
        unit: 'gram',
        costPerUnit: 45,
        totalCost: 4500,
        preparationNotes: 'Cuci bersih paha ayam 100 gram (1 potong sedang). Marinasi dengan bumbu kuning (kunyit 5g, bawang putih 5g, ketumbar 2g, garam 1g) selama minimal 30 menit agar bumbu meresap sempurna. Goreng dengan minyak panas sedang hingga kuning keemasan dan matang merata (15-20 menit). Tiriskan minyak sebelum sajikan.',
        substitutes: ['Ayam Kampung (lebih gurih, +Rp 5/g)', 'Ayam Fillet (lebih lembut, sama harga)'],
        isOptional: false
      },
      {
        menuId: menu2.id,
        inventoryItemId: findInventoryItem('TAH-001')?.id,
        ingredientName: 'Tahu Putih',
        quantity: 50,
        unit: 'gram',
        costPerUnit: 10,
        totalCost: 500,
        preparationNotes: 'Gunakan tahu Sumedang atau tahu putih lokal 50 gram (1 potong besar). Potong kotak persegi 3x3 cm setebal 2 cm. Goreng dalam minyak panas hingga permukaan kuning keemasan dan renyah di luar, lembut di dalam (8-10 menit). Jangan dibalik terlalu sering agar tidak hancur.',
        substitutes: ['Tahu Sutra (lebih lembut, +Rp 5/g)', 'Tempe (protein nabati, sama harga)'],
        isOptional: false
      },
      {
        menuId: menu2.id,
        inventoryItemId: findInventoryItem('KOL-001')?.id,
        ingredientName: 'Kol/Kubis',
        quantity: 30,
        unit: 'gram',
        costPerUnit: 8,
        totalCost: 240,
        preparationNotes: 'Pilih kol segar 30 gram (3-4 lembar). Cuci bersih dengan air mengalir, rendam air garam 5 menit untuk menghilangkan ulat kecil. Iris tipis memanjang setebal 0.5 cm. Kol mentah memberikan tekstur renyah dan segar sebagai lalapan. Sajikan segera setelah diiris agar tetap renyah.',
        substitutes: ['Selada (lebih segar, +Rp 4/g)', 'Sawi Putih (lebih manis, +Rp 2/g)'],
        isOptional: false
      },
      {
        menuId: menu2.id,
        inventoryItemId: findInventoryItem('TMN-001')?.id,
        ingredientName: 'Timun',
        quantity: 30,
        unit: 'gram',
        costPerUnit: 8,
        totalCost: 240,
        preparationNotes: 'Pilih timun segar hijau 30 gram (1/3 buah sedang). Cuci bersih, kupas kulit tipis-tipis jika pahit. Iris bulat setebal 0.5 cm atau iris panjang memanjang. Timun memberikan kesegaran dan mengurangi rasa pedas sambal. Rendam air dingin 5 menit agar lebih renyah.',
        substitutes: ['Mentimun Jepang (lebih manis, +Rp 10/g)'],
        isOptional: false
      },
      {
        menuId: menu2.id,
        inventoryItemId: findInventoryItem('TMT-001')?.id,
        ingredientName: 'Tomat',
        quantity: 20,
        unit: 'gram',
        costPerUnit: 15,
        totalCost: 300,
        preparationNotes: 'Gunakan tomat merah segar 20 gram (1/2 buah sedang). Cuci bersih, potong wedges (8 bagian) atau iris bulat. Tomat memberikan rasa asam segar dan vitamin C. Pilih tomat yang matang merah tapi masih keras agar tidak lembek saat dimakan.',
        substitutes: ['Tomat Ceri (lebih manis, +Rp 25/g)'],
        isOptional: false
      },
      {
        menuId: menu2.id,
        inventoryItemId: findInventoryItem('CBR-001')?.id,
        ingredientName: 'Sambal Terasi (Cabe Rawit)',
        quantity: 25,
        unit: 'gram',
        costPerUnit: 45,
        totalCost: 1125,
        preparationNotes: 'Ulek 15 gram cabe rawit merah segar, 3 siung bawang merah, 2 siung bawang putih, 5 gram terasi bakar, 1 gram garam, 1 sendok teh air jeruk nipis. Ulek kasar agar tekstur tidak terlalu halus. Sambal terasi khas Sunda harus pedas, gurih terasi, dan segar. Jangan terlalu banyak air agar sambal kental.',
        substitutes: ['Sambal Bawang (tidak terasi, -Rp 10/g)', 'Sambal Kecap (lebih manis, -Rp 5/g)'],
        isOptional: false
      },
      {
        menuId: menu2.id,
        inventoryItemId: findInventoryItem('KNY-001')?.id,
        ingredientName: 'Kunyit (Bumbu Kuning)',
        quantity: 5,
        unit: 'gram',
        costPerUnit: 18,
        totalCost: 90,
        preparationNotes: 'Parut halus kunyit segar 5 gram (1 ruas jari kecil) untuk bumbu marinasi ayam. Kunyit memberikan warna kuning cerah khas ayam goreng Sunda dan aroma harum. Campurkan dengan bawang putih, ketumbar, dan garam untuk bumbu lengkap. Kunyit segar lebih harum dari bubuk.',
        substitutes: ['Kunyit Bubuk (lebih praktis, -Rp 8/g)'],
        isOptional: false
      },
      {
        menuId: menu2.id,
        inventoryItemId: findInventoryItem('BWP-001')?.id,
        ingredientName: 'Bawang Putih (Bumbu)',
        quantity: 5,
        unit: 'gram',
        costPerUnit: 38,
        totalCost: 190,
        preparationNotes: 'Haluskan 5 gram bawang putih (2 siung besar) untuk bumbu marinasi ayam. Bawang putih memberikan aroma gurih dan membantu melunakkan daging ayam. Haluskan bersama kunyit dan ketumbar untuk bumbu yang meresap sempurna.',
        substitutes: ['Bawang Putih Bubuk (darurat, -Rp 20/g)'],
        isOptional: false
      },
      {
        menuId: menu2.id,
        inventoryItemId: findInventoryItem('KTB-001')?.id,
        ingredientName: 'Ketumbar',
        quantity: 2,
        unit: 'gram',
        costPerUnit: 35,
        totalCost: 70,
        preparationNotes: 'Sangrai 2 gram ketumbar biji (1/2 sendok teh) dengan api kecil hingga harum (3 menit), lalu tumbuk kasar. Ketumbar sangrai memberikan aroma khas dan rasa gurih pada ayam goreng. Jangan sangrai terlalu lama agar tidak gosong dan pahit.',
    ...
    data: [
      {
        ...
        costPerUnit: 12,
        totalCost: 960,
        preparationNotes: 'Cuci beras 80 gram hingga bersih, rendam 15 menit. Masak dengan perbandingan air 1.2:1 untuk nasi pulen. Nasi harus hangat saat disajikan dengan pepes ikan agar aroma harum daun pisang tercium sempurna.',
        substitutes: ['Beras Merah (lebih sehat, +Rp 3/g)', 'Beras Pandan (harum, +Rp 5/g)'],
        isOptional: false
      },
      {
        menuId: menu3.id,
        inventoryItemId: findInventoryItem('IKN-001')?.id,
        ingredientName: 'Ikan Mas Fillet',
        quantity: 80,
        unit: 'gram',
        costPerUnit: 45,
        totalCost: 3600,
        preparationNotes: 'Pilih ikan mas segar dari Waduk Jatiluhur 80 gram (1 potong sedang). Cuci bersih, buang sisik dan duri halus. Lumuri dengan jeruk nipis 1 sendok teh dan garam 1/2 sendok teh selama 10 menit untuk menghilangkan bau amis. Ikan mas Jatiluhur memiliki daging tebal dan gurih khas air tawar.',
        substitutes: ['Ikan Nila (lebih ekonomis, -Rp 10/g)', 'Ikan Gurame (lebih premium, +Rp 25/g)'],
        isOptional: false
      },
      {
        menuId: menu3.id,
        inventoryItemId: findInventoryItem('DPS-001')?.id,
        ingredientName: 'Daun Pisang',
        quantity: 1,
        unit: 'lembar',
        costPerUnit: 500,
        totalCost: 500,
        preparationNotes: 'Gunakan daun pisang segar ukuran 20x25 cm (1 lembar). Bersihkan dengan lap basah, layukan sebentar di atas api agar lentur dan tidak sobek saat dilipat. Daun pisang memberikan aroma harum khas pepes Sunda. Lipat membentuk amplop dengan bagian mengkilap di dalam agar ikan tidak lengket.',
        substitutes: ['Alumunium Foil (darurat, tidak ada aroma, -Rp 300)'],
        isOptional: false
      },
      {
        menuId: menu3.id,
        inventoryItemId: findInventoryItem('TMP-001')?.id,
        ingredientName: 'Tempe Mendoan',
        quantity: 40,
        unit: 'gram',
        costPerUnit: 10,
        totalCost: 400,
        preparationNotes: 'Iris tempe 40 gram (2 potong) setebal 0.5 cm. Celup ke adonan tepung terigu 20g + ketumbar 1g + daun bawang 2g + air 30ml hingga rata tipis. Goreng dalam minyak panas sedang hingga crispy kuning keemasan (3 menit per sisi). Jangan terlalu tebal agar mendoan renyah.',
        substitutes: ['Tempe Goreng Biasa (tanpa tepung, -Rp 2/g)', 'Tahu Goreng (alternatif protein, sama harga)'],
        isOptional: false
      },
      {
        menuId: menu3.id,
        inventoryItemId: findInventoryItem('LBS-001')?.id,
        ingredientName: 'Sayur Asem (Labu, Kacang, Jagung)',
        quantity: 80,
        unit: 'gram',
        costPerUnit: 8,
        totalCost: 640,
        preparationNotes: 'Campur labu siam 30g (potong dadu 2x2cm), kacang panjang 25g (potong 3cm), jagung manis 25g (pipil). Rebus dalam 200ml air mendidih dengan asam jawa 5g, garam 1g, gula merah 3g, lengkuas 2g selama 15 menit. Sayur asem Sunda harus asam segar dengan tekstur sayuran masih renyah.',
        substitutes: ['Sayur Sop (tidak asam, -Rp 2/g)', 'Sayur Lodeh (lebih gurih, sama harga)'],
        isOptional: false
      },
      {
        menuId: menu3.id,
        inventoryItemId: findInventoryItem('KRK-001')?.id,
        ingredientName: 'Kerupuk Udang',
        quantity: 10,
        unit: 'gram',
        costPerUnit: 20,
        totalCost: 200,
        preparationNotes: 'Goreng 10 gram kerupuk udang mentah (3-4 keping) dalam minyak panas 180°C hingga mengembang sempurna (5 detik per keping). Angkat segera agar tidak gosong dan tetap renyah. Tiriskan minyak, sajikan hangat. Kerupuk udang menambah tekstur renyah dan gurih.',
    ...
    data: [
      {
        ...
        costPerUnit: 12,
        totalCost: 960,
        preparationNotes: 'Cuci beras 80 gram hingga bersih, rendam 15 menit. Masak dengan perbandingan air 1.2:1 untuk nasi pulen. Nasi harus hangat dan pulen agar cocok dimakan dengan kuah sayur asem yang segar dan asam.',
        substitutes: ['Beras Merah (lebih sehat, +Rp 3/g)', 'Beras Organik (premium, +Rp 8/g)'],
        isOptional: false
      },
      {
        menuId: menu4.id,
        inventoryItemId: findInventoryItem('AYM-001')?.id,
        ingredientName: 'Iga Ayam Kampung',
        quantity: 70,
        unit: 'gram',
        costPerUnit: 50,
        totalCost: 3500,
        preparationNotes: 'Gunakan iga ayam kampung 70 gram (1-2 potong kecil). Cuci bersih, rebus dengan lengkuas 5g, sereh 3g, daun salam 1 lembar, garam 1g dalam 400ml air selama 40 menit hingga empuk dan kaldu gurih. Ayam kampung memberikan kaldu yang lebih harum dan daging lebih kenyal daripada broiler.',
      ...
      },
      {
        menuId: menu4.id,
        inventoryItemId: findInventoryItem('LBS-001')?.id,
        ingredientName: 'Labu Siam',
        quantity: 50,
        unit: 'gram',
        costPerUnit: 6,
        totalCost: 300,
        preparationNotes: 'Kupas labu siam 50 gram, potong dadu 2x2 cm. Labu siam memberikan tekstur renyah dan sedikit manis pada sayur asem. Masukkan setelah kaldu mendidih, masak 10 menit hingga empuk tapi tidak lembek. Labu siam menyerap rasa asam dengan sempurna.',
        substitutes: ['Labu Kuning (lebih manis, +Rp 2/g)', 'Terong (tekstur lebih lembut, -Rp 1/g)'],
        isOptional: false
      },
      {
        menuId: menu4.id,
        inventoryItemId: findInventoryItem('KCG-001')?.id,
        ingredientName: 'Kacang Panjang',
        quantity: 30,
        unit: 'gram',
        costPerUnit: 7,
        totalCost: 210,
        preparationNotes: 'Siangi kacang panjang 30 gram (3-4 helai), cuci bersih. Potong-potong sepanjang 3 cm. Masukkan 7 menit sebelum angkat agar tetap renyah dan hijau segar. Kacang panjang menambah serat dan tekstur renyah pada sayur asem.',
        substitutes: ['Buncis (lebih manis, +Rp 3/g)', 'Kacang Kapri (lebih empuk, +Rp 8/g)'],
        isOptional: false
      },
      {
        menuId: menu4.id,
        inventoryItemId: findInventoryItem('JGM-001')?.id,
        ingredientName: 'Jagung Manis',
        quantity: 40,
        unit: 'gram',
        costPerUnit: 10,
        totalCost: 400,
        preparationNotes: 'Pipil jagung manis 40 gram dari tongkol (sekitar 1/4 tongkol). Cuci bersih. Jagung manis memberikan rasa manis alami yang menyeimbangkan asam dari asam jawa. Masukkan bersama labu siam agar empuk sempurna (10 menit).',
        substitutes: ['Jagung Pipil Frozen (lebih praktis, +Rp 5/g)'],
        isOptional: false
      },
      {
        menuId: menu4.id,
        inventoryItemId: findInventoryItem('ASM-001')?.id,
        ingredientName: 'Asam Jawa',
        quantity: 15,
        unit: 'gram',
        costPerUnit: 8,
        totalCost: 120,
        preparationNotes: 'Larutkan 15 gram asam jawa (1 sendok makan penuh) dalam 50ml air hangat, peras dan saring untuk mendapatkan air asam jawa murni. Asam jawa memberikan rasa asam segar khas sayur asem Sunda. Tambahkan 5 menit sebelum angkat agar rasa asam tidak terlalu tajam. Jangan terlalu banyak agar tidak kecut.',
        substitutes: ['Asam Jawa Cair (lebih praktis, +Rp 2/g)', 'Air Jeruk Nipis (rasa berbeda, -Rp 3/g)'],
        isOptional: false
      },
      {
        menuId: menu4.id,
        inventoryItemId: findInventoryItem('BWM-001')?.id,
        ingredientName: 'Bumbu Sayur Asem (Bawang Merah, Cabe, Gula Merah)',
        quantity: 25,
        unit: 'gram',
        costPerUnit: 12,
        totalCost: 300,
        preparationNotes: 'Iris tipis 15 gram bawang merah (3 siung), 5 gram cabe merah keriting (1 buah), 5 gram gula merah. Tumis bumbu iris dengan 1 sendok teh minyak hingga harum (3 menit), lalu masukkan ke kuah sayur asem bersama lengkuas dan sereh. Bumbu iris memberikan aroma harum dan rasa kompleks pada sayur asem.',
    ...
    data: [
      {
        ...
        costPerUnit: 12,
        totalCost: 960,
        preparationNotes: 'Cuci beras 80 gram hingga bersih, rendam 15 menit. Masak dengan perbandingan air 1.2:1 untuk nasi pulen hangat. Nasi harus pulen dan hangat agar cocok dimakan dengan empal gepuk yang gurih empuk.',
        substitutes: ['Beras Merah (lebih sehat, +Rp 3/g)', 'Beras Pandan (harum, +Rp 5/g)'],
        isOptional: false
      },
      {
        ...
        ingredientName: 'Daging Sapi Sengkel',
        quantity: 70,
        unit: 'gram',
        costPerUnit: 100,
        totalCost: 7000,
        preparationNotes: 'Gunakan daging sapi sengkel 70 gram (1 potong kecil). Rebus dengan 400ml air, lengkuas 5g, sereh 3g, daun salam 1 lembar selama 90 menit hingga sangat empuk. Angkat, dinginkan 10 menit. Gepuk/pukul daging dengan ulekan hingga pipih setebal 1 cm untuk tekstur lembut khas empal. Goreng kering dengan minyak sedikit hingga cokelat keemasan (15 menit). Empal gepuk Sunda harus empuk, gurih, dan sedikit manis.',
      ...
      },
      {
        menuId: menu5.id,
        inventoryItemId: findInventoryItem('KOL-001')?.id,
        ingredientName: 'Lalapan (Kubis, Timun, Kemangi)',
        quantity: 40,
        unit: 'gram',
        costPerUnit: 7,
        totalCost: 280,
        preparationNotes: 'Campurkan 20 gram kubis iris tipis, 15 gram timun iris bulat, 5 gram kemangi segar. Cuci bersih semua lalapan, rendam air garam 5 menit lalu bilas. Lalapan harus segar dan renyah sebagai penyeimbang empal yang gurih. Sajikan segera agar tidak layu.',
  ...
  await prisma.menuIngredient.createMany({
    data: [
      {
        menuId: menu6.id,
        inventoryItemId: findInventoryItem('ROT-001')?.id,
        ingredientName: 'Roti Gandum',
        quantity: 70,
        unit: 'gram',
        costPerUnit: 30,
        totalCost: 2100,
        preparationNotes: 'Gunakan 2 lembar roti gandum tawar segar (70 gram total). Roti gandum lebih sehat dengan serat tinggi dan vitamin B kompleks. Panggang sebentar dengan mentega agar renyah dan harum (3 menit per sisi). Jangan terlalu kering agar tetap lembut di dalam.',
        substitutes: ['Roti Tawar Putih (kurang serat, -Rp 8/g)', 'Roti Multigrain (lebih sehat, +Rp 15/g)'],
        isOptional: false
      },
      {
        menuId: menu6.id,
        inventoryItemId: findInventoryItem('PSG-001')?.id,
        ingredientName: 'Pisang Ambon',
        quantity: 80,
        unit: 'gram',
        costPerUnit: 15,
        totalCost: 1200,
        preparationNotes: 'Kupas pisang ambon matang 80 gram (1 buah sedang). Potong memanjang tipis setebal 0.5 cm atau iris bulat. Pisang ambon memberikan rasa manis alami, kalium tinggi, dan tekstur lembut. Pilih pisang yang matang kuning dengan bintik cokelat agar lebih manis dan harum.',
        substitutes: ['Pisang Raja (lebih manis, +Rp 5/g)', 'Pisang Cavendish (import, +Rp 10/g)'],
        isOptional: false
      },
      {
        menuId: menu6.id,
        inventoryItemId: findInventoryItem('SLC-001')?.id,
        ingredientName: 'Selai Cokelat',
        quantity: 30,
        unit: 'gram',
        costPerUnit: 35,
        totalCost: 1050,
        preparationNotes: 'Oles 30 gram selai cokelat (2 sendok makan) merata di permukaan roti gandum. Gunakan selai cokelat dengan kandungan kakao minimal 30% untuk rasa cokelat yang kaya. Oles tipis merata agar tidak terlalu manis dan menutupi rasa pisang.',
        substitutes: ['Selai Kacang (protein tinggi, sama harga)', 'Selai Strawberry (rasa berbeda, -Rp 5/g)'],
        isOptional: false
      },
      {
        menuId: menu6.id,
        inventoryItemId: findInventoryItem('MTG-001')?.id,
        ingredientName: 'Mentega',
        quantity: 10,
        unit: 'gram',
        costPerUnit: 40,
        totalCost: 400,
        preparationNotes: 'Oles tipis 10 gram mentega (1 sendok teh) di sisi luar roti sebelum dipanggang. Mentega memberikan aroma harum, tekstur renyah, dan rasa gurih. Gunakan api sedang agar mentega tidak gosong. Mentega juga menambah kalori dan vitamin A untuk anak-anak.',
    ...
    data: [
      {
        menuId: menu7.id,
        inventoryItemId: findInventoryItem('KCG-001')?.id,
        ingredientName: 'Kacang Hijau',
        quantity: 80,
        unit: 'gram',
        costPerUnit: 18,
        totalCost: 1440,
        preparationNotes: 'Cuci bersih 80 gram kacang hijau (4 sendok makan), buang kotoran dan kacang yang mengapung. Rendam dalam air bersih 2-3 jam agar cepat empuk. Rebus dengan 400ml air dan 2 lembar daun pandan dalam panci hingga mendidih, kecilkan api dan masak 40 menit hingga kacang lembut dan pecah. Kacang hijau kaya protein, serat, dan zat besi untuk anak-anak.',
      ...
      },
      {
        ...
        costPerUnit: 12,
        totalCost: 1200,
        preparationNotes: 'Gunakan 100ml santan kental dari 1/4 kelapa parut. Tambahkan santan 5 menit sebelum angkat agar tidak pecah dan tetap kental. Aduk perlahan agar santan tidak menggumpal. Santan memberikan rasa gurih dan tekstur creamy pada bubur kacang hijau. Jangan mendidihkan santan agar tidak pecah.',
        substitutes: ['Santan Instan (lebih praktis, sama harga)', 'Susu Cair (rasa berbeda, +Rp 5/ml)'],
        isOptional: false
      },
      {
        menuId: menu7.id,
        inventoryItemId: findInventoryItem('GLP-001')?.id,
        ingredientName: 'Gula Pasir',
        quantity: 40,
        unit: 'gram',
        costPerUnit: 14,
        totalCost: 560,
        preparationNotes: 'Tambahkan 40 gram gula pasir (3 sendok makan) setelah kacang lembut. Aduk hingga larut sempurna. Gula pasir memberikan rasa manis yang pas, tidak terlalu pekat seperti gula merah. Sesuaikan tingkat kemanisan dengan selera anak-anak. Jangan terlalu manis agar tidak menutupi aroma pandan.',
        substitutes: ['Gula Aren (rasa lebih kaya, +Rp 10/g)', 'Madu (lebih sehat, +Rp 80/g)'],
        isOptional: false
      },
      {
        menuId: menu7.id,
        inventoryItemId: findInventoryItem('PDN-001')?.id,
        ingredientName: 'Daun Pandan',
        quantity: 2,
        unit: 'lembar',
        costPerUnit: 100,
        totalCost: 200,
        preparationNotes: 'Cuci bersih 2 lembar daun pandan segar, simpul ujungnya agar tidak lepas saat direbus. Masukkan bersamaan dengan kacang hijau dari awal agar aroma pandan meresap sempurna. Daun pandan memberikan aroma harum khas dan warna hijau alami. Angkat daun pandan sebelum disajikan.',
        substitutes: ['Ekstrak Pandan (lebih praktis, -Rp 50/porsi)'],
        isOptional: false
      },
      {
        menuId: menu7.id,
        inventoryItemId: findInventoryItem('GRM-001')?.id,
        ingredientName: 'Garam',
        quantity: 2,
        unit: 'gram',
        costPerUnit: 5,
        totalCost: 10,
        preparationNotes: 'Tambahkan sejumput garam (2 gram / 1/4 sendok teh) setelah gula larut untuk menyeimbangkan rasa manis. Garam membuat rasa manis lebih bulat dan menonjolkan aroma santan. Jangan terlalu banyak agar tidak terasa asin.',
        substitutes: [],
        isOptional: false
      }
    ],
  ...
  await prisma.menuIngredient.createMany({
    data: [
      ...
      },
      {
        ...
        costPerUnit: 12,
        totalCost: 1800,
        preparationNotes: 'Gunakan 150ml santan kental dari 1/3 kelapa parut. Santan memberikan aroma harum dan rasa gurih pada nagasari. Masak santan dengan api kecil agar tidak pecah. Aduk terus saat mencampur dengan tepung beras. Santan yang baik membuat nagasari lembut dan tidak cepat basi.',
      ...
      },
      {
        menuId: menu8.id,
        inventoryItemId: findInventoryItem('PSG-001')?.id,
        ingredientName: 'Pisang Raja',
        quantity: 100,
        unit: 'gram',
        costPerUnit: 18,
        totalCost: 1800,
        preparationNotes: 'Kupas pisang raja matang 100 gram (1 buah), potong memanjang tipis setebal 1 cm. Pisang raja lebih harum dan manis daripada pisang ambon. Letakkan 2-3 potong pisang di tengah adonan nagasari sebelum dikukus. Pisang raja tidak mudah hancur saat dikukus dan aromanya harum khas.',
      ...
      },
      {
        ...
        costPerUnit: 14,
        totalCost: 420,
        preparationNotes: 'Larutkan 30 gram gula pasir (2.5 sendok makan) ke dalam adonan santan tepung beras. Gula memberikan rasa manis yang pas, tidak berlebihan. Aduk hingga gula larut sempurna sebelum dimasak. Rasa nagasari harus manis alami dari gula dan pisang, tidak terlalu pekat.',
  ...
  await prisma.menuIngredient.createMany({
    data: [
      ...
      },
      {
        ...
        costPerUnit: 14,
        totalCost: 140,
        preparationNotes: 'Campurkan 10 gram gula pasir (1 sendok makan) ke dalam adonan tepung untuk sedikit rasa manis. Gula membantu warna keemasan saat digoreng dan menambah rasa. Jangan terlalu banyak agar tidak terlalu manis dan menutupi rasa pisang alami.',
        substitutes: [],
        isOptional: false
      }
    ],
  ...
  await prisma.menuIngredient.createMany({
    data: [
      {
        menuId: menu10.id,
        inventoryItemId: findInventoryItem('KDL-001')?.id,
        ingredientName: 'Kedelai Kuning',
        quantity: 80,
        unit: 'gram',
        costPerUnit: 15,
        totalCost: 1200,
        preparationNotes: 'Rendam 80 gram kedelai kuning kering (5 sendok makan) dalam air 8 jam atau semalaman hingga mengembang 2x lipat. Kupas kulit ari dengan meremas dalam air. Blender kedelai dengan 600ml air hingga sangat halus (3-4 menit). Saring dengan kain saring halus, peras untuk mendapatkan susu kedelai murni. Kedelai kaya protein nabati, isoflavon, dan cocok untuk anak lactose intolerant.',
        substitutes: ['Kedelai Hitam (lebih kaya antioksidan, +Rp 8/g)'],
        isOptional: false
      },
      {
        menuId: menu10.id,
        inventoryItemId: findInventoryItem('CKT-001')?.id,
        ingredientName: 'Bubuk Cokelat',
        quantity: 20,
        unit: 'gram',
        costPerUnit: 50,
        totalCost: 1000,
        preparationNotes: 'Larutkan 20 gram bubuk cokelat murni (3 sendok makan) dalam 50ml air hangat hingga tidak ada gumpalan. Gunakan cokelat dengan kandungan kakao minimal 40% untuk rasa cokelat yang kaya. Masukkan larutan cokelat ke susu kedelai yang sudah mendidih, aduk rata. Cokelat menambah antioksidan dan rasa yang disukai anak-anak.',
      ...
      },
      {
        ...
        costPerUnit: 14,
        totalCost: 700,
        preparationNotes: 'Tambahkan 50 gram gula pasir (4 sendok makan) ke dalam susu kedelai setelah mendidih. Aduk hingga larut sempurna. Gula menghilangkan rasa langu kedelai dan memberikan rasa manis yang pas untuk anak-anak. Sesuaikan tingkat kemanisan dengan selera. Masak 10 menit dengan api kecil sambil diaduk agar gula larut sempurna.',
      ...
      },
      {
        ...
        costPerUnit: 5,
        totalCost: 5,
        preparationNotes: 'Tambahkan sejumput garam (1 gram / 1/4 sendok teh) untuk menyeimbangkan rasa manis dan mengurangi rasa langu kedelai. Garam membuat rasa cokelat lebih menonjol. Jangan terlalu banyak agar tidak terasa asin.',
        substitutes: [],
        isOptional: false
      }
    ],
